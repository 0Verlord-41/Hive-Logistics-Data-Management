...
create_hive_database = DataprocSubmitHiveJobOperator(
    ...
    cluster_name='cluster-3f44',
    region='us-central1',
    project_id='propane-forge-449614-e6',
    dag=dag
)
...
create_hive_table = DataprocSubmitHiveJobOperator(
    ...
    query="""
        ...
        STORED AS TEXTFILE
        LOCATION 'gs://logistics-unprocessed-bucket/input_data/'
...
archive_processed_file = BashOperator(
    ...
    bash_command=f"gsutil -m mv gs://logistics-unprocessed-bucket/input_data/logistics_*.csv gs://logistics-files-archive/",
    dag=dag
)
